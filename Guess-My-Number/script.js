...
// console.log(document.querySelector('p.message').textContent);

// document.querySelector('p.message').textContent = 'Correct Answer!';

// console.log(document.querySelector('p.message').textContent);

// console.log((document.querySelector('div.number').textContent = 14));

// console.log((document.querySelector('span.score').textContent = 10));
